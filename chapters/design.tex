...
%This is shown in the following figure todo. 
...
With MobX, the first step is to declare the state and make the relevant parts of it observable. This is usually done in ES6 (ECMAScript \index{ECMAScript} is the standard that JavaScript conforms to) classes.
...
The User and UserStore classes will serve this purpose. User instance contains data such as user name and id, and also user password, token, role and other. It is also the place where the user's search history is kept.
