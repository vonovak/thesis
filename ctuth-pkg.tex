...
%\cs_new:Nx \ctuthesis_geometry_hmarginratio2: {4\string :6}
...
\cs_new_protected:Nn \ctuthesis_geometry_title: {
	\newgeometry {
		...
		%hmarginratio = {4\string :6} ,
		% Increase the width by 20%, but do not exceed 420pt
		textwidth = \dim_min:nn { 410pt } { 1.2 \g_ctuthesis_geometry_textwidth_dim } ,
	 	textheight = \g_ctuthesis_geometry_textheight_dim ,
...
%changed the box color - vojta
\def\labelenumi{{\normalfont{\theenumi.}}}
\def\labelenumii{{\normalfont(0.1em)(0.1em){\theenumii.}}}
\def\labelenumiii{{\normalfont(\theenumiii)}}
\def\labelenumiv{{\normalfont(\theenumiv)}}
